...
import type { OrderSpoke, OrderSpokeInterface } from "../OrderSpoke";
...
export class OrderSpoke__factory {
  static readonly abi = _abi;
  static createInterface(): OrderSpokeInterface {
    return new Interface(_abi) as OrderSpokeInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): OrderSpoke {
    return new Contract(address, _abi, runner) as unknown as OrderSpoke;
  }
}
